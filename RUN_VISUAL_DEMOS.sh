...
case $choice in
    ...
    4)
        ...
        timeout 20 python3 demo_health.py 2>/dev/null || true
        echo ""
        echo "Demo 2/3: Gesture Control (20 seconds)"
        timeout 20 python3 demo_gesture.py 2>/dev/null || true
        echo ""
        echo "Demo 3/3: Vision System (20 seconds)"
        timeout 20 python3 demo_vision.py 2>/dev/null || true
        echo ""
